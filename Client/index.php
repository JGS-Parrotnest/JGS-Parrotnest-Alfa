        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-tabs">
                    ...
                    <button class="tab-button" id="settingsLogoutBtn" style="color: #ffeecc; font-weight: 700;">Wyloguj</button>
                </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="themes-list">
                            ...
                            <label class="theme-option">
                                ...
                                <input type="radio" class="theme-radio" name="theme" value="dark" id="themeDark" checked>
                            </label>
                        </div>
