...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (messageInput) {
        ...
        function updateChatList() {
            ...
            if (!globalFolder || !globalFolderBody || !globalChatItem) return;
            ...
            if (friendsFolder && friendsFolderBody) {
                chatList.appendChild(friendsFolder);
            }
            if (groupsFolder && groupsFolderBody) {
                chatList.appendChild(groupsFolder);
            }
        ...
        if (globalFolderHeader && globalFolderBody) {
            globalFolderHeader.addEventListener('click', () => {
                ...
                if (collapsed) {
                    globalFolderHeader.classList.add('collapsed');
                } else {
                    globalFolderHeader.classList.remove('collapsed');
                }
            });
        }
        ...
        if (friendsFolderHeader && friendsFolderBody) {
            friendsFolderHeader.addEventListener('click', () => {
                ...
                if (collapsed) {
                    friendsFolderHeader.classList.add('collapsed');
                } else {
                    friendsFolderHeader.classList.remove('collapsed');
                }
            });
        }
        ...
        if (groupsFolderHeader && groupsFolderBody) {
            groupsFolderHeader.addEventListener('click', () => {
                ...
                if (collapsed) {
                    groupsFolderHeader.classList.add('collapsed');
                } else {
                    groupsFolderHeader.classList.remove('collapsed');
                }
            });
        }
        ...
        tabButtons.forEach(button => {
            button.addEventListener('click', () => {
                if (button.id === 'settingsLogoutBtn') return;
                tabButtons.forEach(btn => {
                    if (btn.id !== 'settingsLogoutBtn') btn.classList.remove('active');
                });
        ...
        if (saveThemeBtn) {
            saveThemeBtn.addEventListener('click', () => {
                const selected = (themeDarkRadio && themeDarkRadio.checked) ? 'dark' : 'vibrant';
